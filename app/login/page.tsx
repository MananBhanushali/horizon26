      ...
      >
        ...
        <div className="mb-6 rounded-2xl border border-[var(--color-amber-dim)]/30 bg-[var(--color-amber-soft)] px-4 py-3 text-sm text-[var(--color-amber-dim)]">
          ...
          <div className="mt-1 text-[11px]">
            Try <b>family / demo123</b> for collective household planning.
          </div>
        </div>
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-4" noValidate>
          <Field label="Username">
            <input
              ...
              className="w-full rounded-2xl border border-[var(--color-edge)] bg-[var(--color-panel)] px-4 py-3 text-sm text-[var(--color-ink)] placeholder:text-[var(--color-ink-dim)] focus:border-[var(--color-cyan-dim)] focus:outline-none"
              placeholder="aditya"
              aria-required
            />
          </Field>
